  ...
  return (
    <main className={styles.container}>
      ...
      <div className={styles.header}>
        ...
        <div className={styles.thisUser}>
          <div className={styles.thisUserEmail}>
            ...
            <div className={styles.spanEmail}>{userEmail}</div>
          </div>
          <div className={styles.thisUserRol}>
            Tu rol: &ensp;
            <div className={`${styles.badge} ${styles[`badge__${userRole.toLowerCase()}`] ?? ""}`}>{userRole}</div>
          </div>
        </div>
        <div className={styles.headerActions}>
          <Button variant="terciary" onClick={() => navigate({ to: "/create-user" })}>
            <span className={styles.plus}>+</span> <span className={styles.agregar}>Agregar</span>
          </Button>
      ...
      <div className={styles.dashboardArea}>
        {dashboardOpen ? (
          <Dashboard users={sortedUsers} onClose={() => setDashboardOpen(false)} />
        ) : (
          <div className={styles.dashboardPlaceholder}>
            <div className={styles.dashboardHeader}>
              <Button variant="smallIcon" onClick={() => setDashboardOpen(true)}>
