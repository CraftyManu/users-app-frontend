...
function LoginRightSide() {
  ...
  return (
    <div className={styles.rightBackground}>
       ...
       */}
      <video onCanPlay={() => setLoaded(true)} className={styles.backgroundVideo} autoPlay muted loop playsInline>
        <source src={backgroundVideo} type="video/mp4" />
      </video>

      {!loaded && <img className={styles.backgroundImage} src="https://mimostejidosartesanales.wordpress.com/wp-content/uploads/2026/07/dna-background.png" />}
